...
def clean_llm_response(response):
    """Clean LLM response to ensure valid JSON or plain text."""
    ...
    # Handle cases where LLM returns a list as plain text (e.g., ['Ami'])
...
def recall_knowledge_15h_Mar_23(message, state, user_id=None, fetch_all=False):
    """
